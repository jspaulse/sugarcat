...
# multiprocessor
qemu-system-arm -M vexpress-a9 -cpu cortex-a9 -smp cores=2 -nographic -kernel kernel.img -dtb test.dtb #-initrd rd.img #vexpress_u-boot -drive format=raw,if=sd,file=$SD_BIN
