...
# multiprocessor
qemu-system-arm -M vexpress-a9 -m 128MB -cpu cortex-a9 -smp cores=2 -nographic -kernel kernel.img -dtb test.dtb -initrd rd.img # -drive format=raw,if=sd,file=$SD_BIN
